...
class Helper {
	...
	//
	public function getCachedString($_key,$_isArray=true)
	{
		$_cache=false;
		$_obj=new Memcache();
	...
	// -- returns cached data or false
	//
	public function getCachedStringWithNameSpace($_key,$_nameSpace='global',$_isArray=true)
	{
		$_cache=false;
		$_obj=new Memcache();
		$_cacheConnected=$_obj->get('memcacheconnected');
	...
	//
	public function setCachedString($_string,$_key,$_ttl=7200)
	{
		$_obj=new Memcache();
		$_cacheConnected=$_obj->get('memcacheconnected');
	...
	//
	public function setCachedStringWithNameSpace($_string,$_key,$_nameSpace='global',$_ttl=7200)
	{
		$_obj=new Memcache();
		$_cacheConnected=$_obj->get('memcacheconnected');
	 ...
	 */		
	public function incLogCounter($_cacheNameSpace)
	{
	 ...
	 * @return INTEGER COUNTER
	 */	
	public function getLogCounter($_cacheNameSpace)
	{
